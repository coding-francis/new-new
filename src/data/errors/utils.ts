 ...
 **/
export function handlePrismaClientKnownRequestError(error: PrismaClientKnownRequestError): DatabaseError  {
    ...
    if (error.code === 'P2001' || error.code === 'P2015') {
    ...
    } else if (error.code === 'P2005' || error.code === 'P2006' || error.code === 'P2007' || error.code === 'P2011') {
        const fields =getFieldFromMeta(error.meta)
        ...
        err = new InternalDbError("An error occurred while processing your data")
    }
